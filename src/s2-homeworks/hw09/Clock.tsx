...
function Clock() {
    ...
    const stringDay = Intl.DateTimeFormat("en-EN", {weekday: "long"}).format(date) || <br/> // пишут студенты
    const stringMonth = Intl.DateTimeFormat("en-EN", {month: "long"}).format(date) || <br/> // пишут студенты
